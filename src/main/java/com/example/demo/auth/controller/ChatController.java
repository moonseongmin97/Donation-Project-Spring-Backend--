...
public class ChatController {
    ...
    public ResponseEntity chatNameCheck(@RequestBody MemberRequestDto member , MemberRequestDto memberDto  ,HttpServletRequest request,  HttpServletResponse res) throws Exception {
    	try {
